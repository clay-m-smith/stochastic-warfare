...
_SENSOR_FUNCTIONAL_SOURCES: Mapping[
...
] = MappingProxyType(
    {
        ...
        _checked_functional_source_key(
            ...
            "https://www.dreadnoughtproject.org/tech/essays/FireControl/"
            "ArgoAimCorrector/; "
            "https://www.usni.org/magazines/naval-history-magazine/2024/"
            "february/barr-and-stroud-rangefinder; "
            "https://www.zeiss.de/corporate/ueber-zeiss/vergangenheit/"
            "geschichte/technische-meilensteine/verteidigungssysteme.html; "
            "https://www.navweaps.com/index_tech/tech-078.php"
        ),
        _checked_functional_source_key(
            "sensor",
            "binoculars_ww1",
            ...
            "https://collectionswa.net.au/items/"
            "95201dcb-848a-4355-99a9-1777437226de; "
            "https://www.awm.gov.au/collection/C311429"
        ),
        _checked_functional_source_key(
            "sensor",
            "esm_suite",
        ...
        _checked_functional_source_key(
            ...
            "https://www.oni.navy.mil/Portals/12/Intel%20agencies/iran/"
            "Iran%20022217SP.pdf; "
            "https://www.usni.org/magazines/proceedings/2006/october/"
            "world-naval-developments-network-centric-warfare-middle-east; "
...
_SENSOR_FUNCTIONAL_SOURCE_OVERRIDE_DECLARATIONS: tuple[
    ...
    # WWI fire-control optics. These sources establish equipment role only;
    # they do not substantiate the retained 3,000 m modeled cap.
    (
    ...
    (
        ...
        "https://www.zeiss.de/corporate/ueber-zeiss/vergangenheit/geschichte/"
    ...
    for equipment_name in equipment_names:
        ...
        records.append(
            SensorAttachmentMapping(
                ...
                modeled_role=modeled_role,
                compatible_weapon_roles=compatible_weapon_roles,
...
EQUIPMENT_MAPPING_RECORDS: tuple[EquipmentMappingRecord, ...] = (
    ...
    *_sensor_records(
        ...
        SensorModeledRole.GROUND_AIR_DEFENSE_FIRE_CONTROL_RADAR,
        "1S91 Straight Flush Radar",
        compatible_weapon_roles=(WeaponModeledRole.AIR_DEFENSE_MISSILE,),
    ...
    *_sensor_records(
        ...
        compatible_weapon_roles=(WeaponModeledRole.AIR_TO_GROUND_MISSILE,),
    ...
    *_sensor_records(
        ...
        "Barr & Stroud Rangefinder",
        "Zeiss Entfernungsmesser Rangefinder",
        compatible_weapon_roles=(WeaponModeledRole.NAVAL_GUNFIRE,),
        modeled_max_range_m=3_000.0,
        modeled_fov_deg=30.0,
    ),
    *_sensor_records(
        ...
        "No. 7 Dial Sight",
        "Panoramic Sight",
        compatible_weapon_roles=(WeaponModeledRole.FIELD_ARTILLERY,),
        modeled_max_range_m=3_000.0,
        modeled_fov_deg=30.0,
    ),
    *_sensor_records(
    ...
    *_sensor_records(
        ...
        compatible_weapon_roles=(WeaponModeledRole.ANTI_SHIP_MISSILE,),
        modeled_max_range_m=60_000.0,
        modeled_fov_deg=360.0,
    ),
    *_sensor_records(
    ...
    *_sensor_records(
        ...
        compatible_weapon_roles=(WeaponModeledRole.BOMB_DELIVERY,),
        modeled_max_range_m=5_000.0,
    ...
    *_sensor_records(
        ...
        "K-14 Gyroscopic Gunsight",
        "Revi 16B Reflector Gunsight",
        compatible_weapon_roles=(WeaponModeledRole.AIRCRAFT_GUN,),
        modeled_max_range_m=3_000.0,
        modeled_fov_deg=30.0,
    ),
    *_sensor_records(
