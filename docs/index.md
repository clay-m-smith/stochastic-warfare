...
![Tests](https://img.shields.io/badge/tests-7%2C894_passing-brightgreen)
![Phase](https://img.shields.io/badge/phase-46_Block--5_COMPLETE-brightgreen)
...
| Block 5 | 40--47 | Core combat fidelity — battle loop wiring, terrain interaction, ROE, composite victory | **In Progress** (40--46 complete) |

**~7,894 tests** across ~340 test files. **~700 YAML data files** defining 131 units, 111 weapons, 123 ammunition types, sensors, signatures, 34 doctrines, 13 commanders, and 41 scenarios.
