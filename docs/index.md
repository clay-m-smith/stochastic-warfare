...
![Tests](https://img.shields.io/badge/tests-10%2C773_passing-brightgreen)
![Phase](https://img.shields.io/badge/phase-99_Block--11-blue)
...
**~10,773 tests** (~10,357 Python + 416 frontend) across ~400 test files. **~766 YAML data files** defining units, weapons, ammunition types, sensors, signatures, doctrines, commanders, and 47 scenarios across 5 eras.
