...
![Tests](https://img.shields.io/badge/tests-7%2C837_passing-brightgreen)
![Phase](https://img.shields.io/badge/phase-45_Block--5_COMPLETE-brightgreen)
...
| Block 5 | 40--47 | Core combat fidelity — battle loop wiring, terrain interaction, ROE, composite victory | **In Progress** (40--45 complete) |

**~7,837 tests** across ~340 test files. **~700 YAML data files** defining 125 units, 107 weapons, 119 ammunition types, sensors, signatures, 34 doctrines, 13 commanders, and 41 scenarios.
