...
![Tests](https://img.shields.io/badge/tests-10%2C354_passing-brightgreen)
![Phase](https://img.shields.io/badge/phase-75_Block--8--IN_PROGRESS-orange)
...
**~10,023 tests** (~9,751 Python + 272 frontend) across ~390 test files. **~735 YAML data files** defining units, weapons, ammunition types, sensors, signatures, doctrines, commanders, and 41 scenarios across 5 eras.
