...
**~8,878 tests** (~8,605 Python + 272 frontend) across ~350 test files. **~735 YAML data files** defining 133 units, 115 weapons, 131 ammunition types, sensors, signatures, 34 doctrines, 30 commanders, and 41 scenarios.
