...
![Tests](https://img.shields.io/badge/tests-10%2C379_passing-brightgreen)
![Phase](https://img.shields.io/badge/phase-76_Block--8--IN_PROGRESS-orange)
...
**~10,379 tests** (~10,107 Python + 272 frontend) across ~390 test files. **~735 YAML data files** defining units, weapons, ammunition types, sensors, signatures, doctrines, commanders, and 41 scenarios across 5 eras.
