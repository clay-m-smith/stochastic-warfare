...
**~8,424 tests** (~8,152 Python + 272 frontend) across ~345 test files. **~700 YAML data files** defining 131 units, 111 weapons, 123 ammunition types, sensors, signatures, 34 doctrines, 13 commanders, and 41 scenarios.
