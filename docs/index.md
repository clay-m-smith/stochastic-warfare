...
![Tests](https://img.shields.io/badge/tests-10%2C820_passing-brightgreen)
![Phase](https://img.shields.io/badge/phase-103_Block--11--COMPLETE-brightgreen)
...
**~10,820 tests** (~10,404 Python + 416 frontend) across ~400 test files. **~865 YAML data files** defining units, weapons, ammunition types, sensors, signatures, doctrines, commanders, and 51 scenarios across 5 eras.
