...
**~9,427 tests** (~9,155 Python + 272 frontend) across ~360 test files. **~735 YAML data files** defining units, weapons, ammunition types, sensors, signatures, doctrines, commanders, and 41 scenarios across 5 eras.
