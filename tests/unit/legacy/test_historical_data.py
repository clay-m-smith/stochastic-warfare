"""Tests for stochastic_warfare.legacy.validation.historical_data."""
...
from stochastic_warfare.validation.contracts import (
    HistoricalMetric as CurrentHistoricalMetric,
)
from stochastic_warfare.validation.contracts import SourceQuality as CurrentSourceQuality
...
class TestSourceQuality:
    def test_legacy_namespace_reexports_current_contract(self) -> None:
        assert SourceQuality is CurrentSourceQuality
        assert HistoricalMetric is CurrentHistoricalMetric
