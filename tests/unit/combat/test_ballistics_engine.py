...
class TestDispersion:
    ...
    def test_dispersion_scales_with_range(self) -> None:
        ...
        assert long.easting - aim.easting == pytest.approx(
            10.0 * (short.easting - aim.easting),
        )
        assert long.northing - aim.northing == pytest.approx(
            10.0 * (short.northing - aim.northing),
        )
