...
def _make_mock_context():
    ...
    ctx.resolved_calibration = ctx.calibration.resolve(())
    ctx.era_config = None
...
class TestContextRoundTrip:
    ...
    def test_multiple_engines_round_trip(self):
        ...
        engines_data = {
            ...
            "suppression_engine": {"zones": [{"center": [100, 200]}]},
        }
...
class TestBattleManagerRoundTrip:
    ...
    def test_full_state_round_trip(self):
        ...
        bm1._battles[battle.battle_id] = battle
        bm1._next_battle_id = 1
        bm1._pending_decisions = {"u1": 45.0}
        bm1._deferred_battle_ids = {"u1": battle.battle_id}
