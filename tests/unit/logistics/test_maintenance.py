...
class TestPoissonBreakdown:
    ...
    def test_deferred_maintenance_increases_breakdown(self) -> None:
        ...
        dt = 50.0
        p_normal = 1.0 - math.exp(-dt / cfg.base_mtbf_hours)
        deferred_mtbf = cfg.base_mtbf_hours / cfg.deferred_maintenance_multiplier
        p_deferred = 1.0 - math.exp(-dt / deferred_mtbf)
