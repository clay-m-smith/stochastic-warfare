...
def _easting_engine(*, seed: int = 42) -> SimulationEngine:
    variant = AnalysisVariant(
        variant_id="phase112-movement-easting",
...
def _two_battle_engine(
    ...
    context = engine._ctx
    # This fixture deliberately places every unit in two active battles to
    # exercise canonical movement-diagnostic ordering.  OODA commanders have
    # exclusive battle ownership, so keep that independent subsystem disabled.
    context.commander_engine = None
    context.ooda_engine = None
