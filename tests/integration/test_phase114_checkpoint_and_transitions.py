...
def test_format_114_persists_one_exact_effective_contract() -> None:
    _register_transition_era()
...
def test_format_114_rejects_invalid_contract_atomically(
    mutation: Callable[[dict[str, Any]], None],
    match: str,
) -> None:
    _register_transition_era()
...
def test_format_114_rejects_invalid_clock_calendar_atomically(
    mutation: Callable[[dict[str, Any]], None],
    match: str,
) -> None:
    engine, _ = _engine()
