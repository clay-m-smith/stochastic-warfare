...
![Tests](https://img.shields.io/badge/tests-8%2C478_passing-brightgreen)
![Phase](https://img.shields.io/badge/phase-53_Block--6_IN--PROGRESS-yellow)
...
tests/                    # 8,206 engine+API+frontend tests across ~340 test files
