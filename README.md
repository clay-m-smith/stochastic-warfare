...
![Tests](https://img.shields.io/badge/tests-8%2C835_passing-brightgreen)
![Phase](https://img.shields.io/badge/phase-64_Block--7-brightgreen)
...
tests/                    # 8,835 engine+API+frontend tests across ~350 test files
