...
export function PlaybackControls({
  ...
  return (
    <div className="flex items-center gap-2 rounded bg-white/90 px-3 py-2 text-xs shadow">
      <button
        onClick={onStepBackward}
        disabled={currentFrame <= 0}
        className="rounded px-1.5 py-0.5 hover:bg-gray-200 disabled:opacity-30"
      ...
      <button
        ...
        className="rounded bg-gray-200 px-2 py-0.5 font-bold hover:bg-gray-300 disabled:opacity-30"
