...
const VARIANT_STYLES = {
  error: { bg: 'bg-red-50', text: 'text-red-700', button: 'text-red-600 hover:text-red-500' },
  warning: { bg: 'bg-yellow-50', text: 'text-yellow-700', button: 'text-yellow-600 hover:text-yellow-500' },
  connection: { bg: 'bg-gray-50', text: 'text-gray-700', button: 'text-blue-600 hover:text-blue-500' },
}
