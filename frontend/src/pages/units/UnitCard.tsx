  ...
  return (
    <Card onClick={onClick}>
      <div className="mb-2 flex items-start justify-between">
        <h3 className="font-semibold text-gray-900">{unit.display_name || unit.unit_type}</h3>
      ...
      <div className="mb-2 flex flex-wrap gap-1">
        ...
        {unit.category && <Badge className="bg-gray-200 text-gray-700">{unit.category}</Badge>}
      </div>
