...
export function WeatherSection({ config, dispatch }: WeatherSectionProps) {
  ...
  return (
    <section>
      <h3 className="mb-3 text-sm font-semibold uppercase tracking-wide text-gray-500">Weather</h3>
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        <label className="block">
          <span className="text-sm text-gray-700">Visibility (m)</span>
          <input
            type="number"
            min={50}
            step={100}
        ...
        <label className="block">
          <span className="text-sm text-gray-700">Wind Speed (m/s)</span>
          <input
            type="number"
            min={0}
            step={1}
        ...
        <label className="block">
          <span className="text-sm text-gray-700">Wind Direction (deg)</span>
          <input
            type="number"
            min={0}
            max={360}
        ...
        <label className="block">
          <span className="text-sm text-gray-700">Cloud Cover (0-1)</span>
          <input
            type="number"
            min={0}
            max={1}
