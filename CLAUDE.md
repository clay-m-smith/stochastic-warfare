...
### Block 4 Phases (37-39) — Planned

| Phase | Focus | Tests | Key Deliverables |
|-------|-------|-------|------------------|
| 37 | Integration Fixes & E2E Validation | ~55 | config_overrides applied, DEW battle loop wiring (5 deficits), reinforcement chart fix, E2E smoke test of all 41 scenarios |
| 38 | Map & Chart Enhancements | ~30 | FOW toggle, detection circles, elevation shading, cross-chart tick sync, dark mode |
| 39 | Quality, Performance & Packaging | ~26 | Test gap closure, virtualized event lists, `uv run python -m api` single-command startup, Docker, dev scripts |
