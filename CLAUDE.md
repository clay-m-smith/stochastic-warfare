...
## Frontend (Phase 33+)
- **Stack**: Vite + React 18 + TypeScript 5.7 + Tailwind v3 + TanStack Query v5 + React Router v6
...
| 33 | Frontend Foundation & Scenario Browser | 58 | React + TypeScript + Tailwind frontend (~50 files). Scenario browser (list+detail), unit catalog with modal, run config/list pages. Vite + TanStack Query + React Router + Headless UI. Zero engine/API changes. |
